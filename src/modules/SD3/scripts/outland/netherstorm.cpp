            ...
            switch (pCreature->GetEntry())
            {
                case NPC_BNAAR_C_CONSOLE:
                    if (urand(0, 1))
                    {
                        ...
                        {
                            pAdd->Movement()->GoTo(0, 2927.36f, 4212.97f, 164.00f);
                        }
                    }
                    else
                    {
                        ...
                        {
                            pAdd->Movement()->GoTo(0, 2933.68f, 4162.55f, 164.00f);
                        }
                    }
                    m_uiWaveTimer = 30000;
                    break;
                ...
                case NPC_ARA_C_CONSOLE:
                    if (urand(0, 1))
                    {
                        ...
                        {
                            pAdd->Movement()->GoTo(0, 4003.42f, 4040.19f, 193.49f);
                        }
                    ...
                    else
                    {
                        ...
                        {
                            pAdd->Movement()->GoTo(0, 4028.01f, 4035.17f, 193.59f);
                        }
        ...
        void DoFinalSpawnForCreature(Creature* pCreature)
        {
            ...
            switch (pCreature->GetEntry())
            {
                ...
                case NPC_DURO_C_CONSOLE:
                    ...
                    {
                        pAdd->Movement()->GoTo(0, 2972.27f, 2193.22f, 164.48f);
                    }
